    ...
    <div id='animeListPage' css={AnimeListPageStyle}>
      <Header>
        <span css={logoContainerStyle}>
          {!isBulkChooseActive && <img src={logo} alt='AnimeCol logo' />}
          {isBulkChooseActive ? <span css={instructionStyle}>Select at least 1 Anime to proceed</span> : 'Anime Collections'}
        </span>
